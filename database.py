...
mydb = mysql.connector.connect(
 host="localhost", user="root", password="root123", database="online_movie_ticket_booking",auth_plugin='mysql_native_password')   #Connect to the database
c  = mydb.cursor() #Create a cursor to execute queries

def login(userid,passwd):
    c.execute("SELECT password, aname FROM pes1ug21cs268_289_admin WHERE aid = %s", (userid,))
