...
-- not null to display that it is mandatory to enter the value
...
insert into pes1ug21cs268_289_admin values(001,'Ajay','ajay@123');
insert into pes1ug21cs268_289_admin values(002,'krishna1','krishna@123');
...
--     IF coun>max1 or coun<1 then      #if the seat number is greater than the capacity of the screen or less than 1
...
-- 	END;$$
-- DELIMITER;
-- count of tickets booked by each user, and store the result in a table count_tickets